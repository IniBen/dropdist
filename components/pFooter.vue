          ...
          <div class="row">
            <div class="col-lg-4 col-md-4 col-xs-12">
              <section class="footer-item">
                <a href="home-01.html" class="logo footer-logo"
                  ><img
                ...
                <div class="footer-phone-info mode-03">
                  ...
                  <p class="r-info">
                    ...
                    <span class="number">0800 0NEW DEVZ</span>
                  </p>
                </div>
                ...
                <div class="biolife-social inline circle-hover">
                  <ul class="socials">
                    <li>
                      <a href="#" title="twitter" class="socail-btn"
                        ><i class="fa fa-twitter" aria-hidden="true"></i
                      ></a>
                    </li>
                    <li>
                      <a href="#" title="facebook" class="socail-btn"
                        ><i class="fa fa-facebook" aria-hidden="true"></i
                      ></a>
                    </li>
                    <li>
                      <a href="#" title="pinterest" class="socail-btn"
                        ><i class="fa fa-pinterest" aria-hidden="true"></i
                      ></a>
                    </li>
                    <li>
                      <a href="#" title="youtube" class="socail-btn"
                        ><i class="fa fa-youtube" aria-hidden="true"></i
                      ></a>
                    </li>
                    <li>
                      <a href="#" title="instagram" class="socail-btn"
            ...
            <div class="col-lg-8 col-md-8 col-xs-12">
              <div class="row">
                <div
                  class="col-lg-4 col-sm-4 col-xs-12 md-margin-top-6px xs-margin-top-40px"
                >
                  <section class="footer-item">
            ...
            <div class="newsletter-block layout-04">
              <div class="wrap-title">
                ...
                <div class="texts">
                  ...
                  <p class="sub-title">
                    Sign up our Newsletter for Exclusive Discount codes
                  </p>
                </div>
              </div>
              <div class="form-content">
                <form action="#" name="new-letter-foter" method="post">
                  ...
                  />
                  <button type="submit" class="bnt-submit" name="ok">
                    Sign up
                  </button>
                </form>
              </div>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="copy-right-text">
                  <p><a href="templateshub.net">Newdevz</a></p>
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-12">
