  ...
  <div>
    <div class="iq-sidebar">
      <div class="iq-sidebar-logo d-flex justify-content-between">
        <a href="index.html">
          <!-- <img src="~/assets/images/newz.svg" class="img-fluid" alt="" /> -->
          <span>Devz</span>
        </a>
        ...
        <nav class="iq-sidebar-menu">
          <ul id="iq-sidebar-toggle" class="iq-menu">
            ...
            <li>
              <NuxtLink
                to="/#index"
                class="iq-bg-primary-hover rounded nav-link router-link-exact-active router-link-active pr-2"
                ><i class="ri-home-4-line pr-2"></i>Home</NuxtLink
              >
            </li>
            <li>
              <NuxtLink to="/"
                ><i class="ri-login-box-line"></i>Logout</NuxtLink
              >
            </li>
            <li>
              <NuxtLink to="/pageWishList"
                ><i class="ri-heart-line"></i>Wishlist</NuxtLink
              >
            </li>
            <li>
              <NuxtLink
                to="/pagedashboard"
                class="iq-bg-primary-hover rounded nav-link router-link-exact-active router-link-active pr-2"
                ><i class="ri-home-3-line pr-2"></i>Dashboard</NuxtLink
              >
            </li>
            <li>
              <a
                ...
                aria-expanded="false"
                ><i class="ri-user-line"></i><span>Profile Management</span
              ...
              >
                <li>
                  <NuxtLink to="/userprofile"
                    ><i class="ri-profile-line"></i>User Profile</NuxtLink
                  >
                </li>
                <li>
                  <NuxtLink to="/userprofileEdit"
                    ><i class="ri-file-edit-line"></i>User Edit</NuxtLink
                  >
                </li>
                <li>
                  <NuxtLink to="/pageadduser"
                    ><i class="ri-user-add-line"></i>User Add</NuxtLink
                  >
                </li>
                <li>
                  <NuxtLink to="/pageuserlist"
                    ><i class="ri-file-list-line"></i>User List</NuxtLink
                  >
                </li>
                <li>
                  <NuxtLink to="/wallet"
                    ><i class="ri-file-list-line"></i>Wallet</NuxtLink
                  >
                </li>
              </ul>
            </li>
            <li>
              <a
                ...
                data-toggle="collapse"
                aria-expanded="false"
                ><i class="ri-mail-line"></i><span>Product Management</span
                ><i class="ri-arrow-right-s-line iq-arrow-right"></i
              ></a>
              <ul
                id="mailbox"
              ...
              >
                <li>
                  <NuxtLink to="/pageaddproduct"
                    ><i class="ri-plus-line">Add Product</i></NuxtLink
                  >
                </li>
                <li>
                  <NuxtLink to="/pageproductDetail"
                    ><i class="ri-plus-line">Product Detail</i></NuxtLink
                  >
                </li>
              </ul>
            </li>
            ...
            <!-- <li>
              ...
              >
                <li>
                  <a href="profile.html"
                    ><i class="ri-profile-line"></i>User Profile</a
                  >
                </li>
                <li>
                  <a href="profile-edit.html"
                    ><i class="ri-file-edit-line"></i>User Edit</a
                  >
                </li>
                <li>
                  <NuxtLink to="/pageadduser"
                    ><i class="ri-user-add-line">Add User</i></NuxtLink
                  >
                </li>
                <li>
                  <a href="user-list.html"
                    ><i class="ri-file-list-line"></i>User List</a
                  >
                </li>
              </ul>
            </li> -->
            ...
            <li>
              <a
                ...
                data-toggle="collapse"
                aria-expanded="false"
                ><i class="ri-shopping-cart-line"></i><span>E-commerce</span
                ><i class="ri-arrow-right-s-line iq-arrow-right"></i
              ></a>
              <ul
                id="ecommerce"
              ...
              >
                <li>
                  <a href="e-commerce-product-list.html"
                    ><i class="ri-file-list-line"></i>Product Listing</a
                  >
                </li>
                <li>
                  <a href="e-commerce-product-detail.html"
                    ><i class="ri-pages-line"></i>Product Details</a
                  >
                </li>
                <li>
                  <a href="e-commerce-checkout.html"
                    ><i class="ri-shopping-cart-2-line"></i>Checkout</a
                  >
                </li>
                <li>
                  <a href="e-commerce-wishlist.html"
              ...
              >
                ...
                <li>
                  <a href="ui-media-object.html"
                    ><i class="ri-camera-line"></i>Media</a
                  >
                </li>
                <li>
            ...
            <li>
              <a
                ...
                data-toggle="collapse"
                aria-expanded="false"
                ><i class="ri-archive-drawer-line"></i><span>Forms Wizard</span
                ><i class="ri-arrow-right-s-line iq-arrow-right"></i
              ></a>
              <ul
                id="wizard-form"
            ...
            <li>
              <a
                ...
                data-toggle="collapse"
                aria-expanded="false"
                ><i class="ri-map-pin-user-line"></i><span>Maps</span
                ><i class="ri-arrow-right-s-line iq-arrow-right"></i
              ></a>
              <ul
                id="map-page"
              ...
              >
                <li>
                  <a href="pages-map.html"
                    ><i class="ri-google-line"></i>Google Map</a
                  >
                </li>
                <li>
                  <a href="#"
                    ><i class="ri-map-pin-range-line"></i>Vector Map</a
                  >
                </li>
              </ul>
            </li>
                  ...
                  <ul>
                    <li>
                      <a
                        ...
                        data-toggle="collapse"
                        aria-expanded="false"
                        ><i class="ri-play-circle-line"></i><span>Sub-menu</span
                        ><i class="ri-arrow-right-s-line iq-arrow-right"></i
                      ></a>
                      <ul
                        id="sub-menu"
                      ...
                      >
                        <li>
                          <a href="#"
                            ><i class="ri-record-circle-line"></i>Sub-menu 1</a
                          >
                        </li>
                        <li>
                          <a href="#"
                            ><i class="ri-record-circle-line"></i>Sub-menu 2</a
                          >
                        </li>
                        <li>
                          <a href="#"
                            ><i class="ri-record-circle-line"></i>Sub-menu 3</a
                          >
                        </li>
                      </ul>
                    </li>
