  ...
  <div>
    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
                <li class="nav-item"><NuxtLink to="/" class="permal-link">Home</NuxtLink></li>
        ...
        <div id="main-content" class="main-content">
            <div class="container">
                ...
                <div class="top-banner background-top-banner-for-shopping min-height-346px">
                    ...
                    <p class="btns">
                        <NuxtLink to="/#" class="btn">Open Account</NuxtLink>
                                ...
                                <table class="shop_table cart-form">
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-thumbnail" data-title="Product Name">
                                            <NuxtLink to="/#" class="prd-thumb" >
                                                <figure><img width="113" height="113" src="~/assets/images/shippingcart/pr-01.jpg" alt="shipping cart"></figure>
                                            </NuxtLink>
                                            <NuxtLink to="/#" class="prd-name" >National Fresh Fruit</NuxtLink>
                                            <div class="action">
                                                <NuxtLink to="/#" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></NuxtLink>
                                                <NuxtLink to="/#" class="remove"><i class="fa fa-trash-o" aria-hidden="true"></i></NuxtLink>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="cart_item wrap-buttons">
                                        <td class="wrap-btn-control" colspan="4">
                                            <NuxtLink to="/#" class="btn back-to-shop">Back to Shop</NuxtLink>
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                            <div class="shpcart-subtotal-block">
                                ...
                                <div class="btn-checkout">
                                    <NuxtLink to="/#" class="btn checkout">Check out</NuxtLink>
                                </div>
