  ...
  <div>
    ...
    <div class="container">
        <nav class="biolife-nav">
            <ul>
                <li class="nav-item"><NuxtLink to="/index-2.html" class="permal-link">Home</NuxtLink></li>
                <li class="nav-item"><NuxtLink to="/#" class="permal-link">Natural Organic</NuxtLink></li>
        ...
        <div class="container">
            ...
            <div id="main-content" class="main-content">
                    ...
                    <div class="product-attribute">
                        ...
                        <div class="product-atts">
                            <div class="atts-item">
                                ...
                                <ul class="color-list">
                                    <li class="color-item"><NuxtLink to="/#" class="c-link"><span class="symbol img-color"></span>Multi</NuxtLink></li>
                                    <li class="color-item"><NuxtLink to="/#" class="c-link"><span class="symbol hex-code color-01"></span>Red</NuxtLink></li>
                                    <li class="color-item"><NuxtLink to="/#" class="c-link"><span class="symbol hex-code color-02"></span>Orrange</NuxtLink></li>
                                    <li class="color-item"><NuxtLink to="/#" class="c-link"><span class="symbol hex-code color-03"></span>Other</NuxtLink></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="action-form">
                        <div class="quantity-box">
                            ...
                            <div class="qty-input">
                                ...
                                <NuxtLink to="/#" class="qty-btn btn-up"><i class="fa fa-caret-up" aria-hidden="true"></i></NuxtLink>
                                <NuxtLink to="/#" class="qty-btn btn-down"><i class="fa fa-caret-down" aria-hidden="true"></i></NuxtLink>
                            </div>
                        </div>
                        ...
                        <div class="buttons">
                            <NuxtLink to="/#" class="btn add-to-cart-btn">add to cart</NuxtLink>
                            <p class="pull-row">
                                <NuxtLink to="/#" class="btn wishlist-btn">wishlist</NuxtLink>
                        ...
                        <div class="social-media">
                            <ul class="social-list">
                                <li><NuxtLink to="/#" class="social-link"><i class="fa fa-twitter" aria-hidden="true"></i></NuxtLink></li>
                                <li><NuxtLink to="/#" class="social-link"><i class="fa fa-facebook" aria-hidden="true"></i></NuxtLink></li>
                                <li><NuxtLink to="/#" class="social-link"><i class="fa fa-pinterest" aria-hidden="true"></i></NuxtLink></li>
                                <li><NuxtLink to="/#" class="social-link"><i class="fa fa-share-alt" aria-hidden="true"></i></NuxtLink></li>
                                <li><NuxtLink to="/#" class="social-link"><i class="fa fa-instagram" aria-hidden="true"></i></NuxtLink></li>
                            </ul>
                        </div>
                ...
                <div class="product-tabs single-layout biolife-tab-contain">
                    <div class="tab-head">
                        <ul class="tabs">
                            <li class="tab-element active"><NuxtLink to="/#tab_1st" class="tab-link">Products Descriptions</NuxtLink></li>
                            <li class="tab-element" ><NuxtLink to="/#tab_2nd" class="tab-link">Addtional information</NuxtLink></li>
                            <li class="tab-element" ><NuxtLink to="/#tab_3rd" class="tab-link">Shipping & Delivery</NuxtLink></li>
                            <li class="tab-element" ><NuxtLink to="/#tab_4th" class="tab-link">Customer Reviews <sup>(3)</sup></NuxtLink></li>
                        </ul>
                    </div>
                                        ...
                                        <div class="review-form-wrapper">
                                            ...
                                            <form action="#" name="frm-review" method="post">
                                                <div class="comment-form-rating">
                                                    ...
                                                    <p class="stars">
                                                        <span>
                                                            <NuxtLink class="btn-rating" data-value="star-1" to="/#"><i class="fa fa-star-o" aria-hidden="true"></i></NuxtLink>
                                                            <NuxtLink class="btn-rating" data-value="star-2" to="/#"><i class="fa fa-star-o" aria-hidden="true"></i></NuxtLink>
                                                            <NuxtLink class="btn-rating" data-value="star-3" to="/#"><i class="fa fa-star-o" aria-hidden="true"></i></NuxtLink>
                                                            <NuxtLink class="btn-rating" data-value="star-4" to="/#"><i class="fa fa-star-o" aria-hidden="true"></i></NuxtLink>
                                                            <NuxtLink class="btn-rating" data-value="star-5" to="/#"><i class="fa fa-star-o" aria-hidden="true"></i></NuxtLink>
                                                        </span>
                                                    </p>
                                                </div>
                                ...
                                <div id="comments">
                                            ...
                                            <div class="comment-container">
                                                <div class="row">
                                                    ...
                                                    <div class="comment-review-form col-lg-3 col-lg-offset-1 col-md-3 col-sm-4 col-xs-12">
                                                        ...
                                                        <ul class="actions">
                                                            <li><NuxtLink to="/#" class="btn-act like" data-type="like"><i class="fa fa-thumbs-up" aria-hidden="true"></i>Yes (100)</NuxtLink></li>
                                                            <li><NuxtLink to="/#" class="btn-act hate" data-type="dislike"><i class="fa fa-thumbs-down" aria-hidden="true"></i>No (20)</NuxtLink></li>
                                                            <li><NuxtLink to="/#" class="btn-act report" data-type="dislike"><i class="fa fa-flag" aria-hidden="true"></i>Report</NuxtLink></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="biolife-panigations-block version-2">
                                        <ul class="panigation-contain">
                                            ...
                                            <li><NuxtLink to="/#" class="link-page">2</NuxtLink></li>
                                            <li><NuxtLink to="/#" class="link-page">3</NuxtLink></li>
                                            <li><span class="sep">....</span></li>
                                            <li><NuxtLink to="/#" class="link-page">20</NuxtLink></li>
                                            <li><NuxtLink to="/#" class="link-page next"><i class="fa fa-angle-right" aria-hidden="true"></i></NuxtLink></li>
                                        </ul>
                                        <div class="result-count">
                                            <p class="txt-count"><b>1-5</b> of <b>126</b> reviews</p>
                                            <NuxtLink to="/#" class="link-to">See all<i class="fa fa-caret-right" aria-hidden="true"></i></NuxtLink>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="product-item">
                            <div class="contain-product layout-default">
                                ...
                                <div class="info">
                                    ...
                                    <h4 class="product-title"><NuxtLink to="/#" class="pr-name">National Fresh Fruit</NuxtLink></h4>
                                    <div class="price">
                                        <ins><span class="price-amount"><span class="currencySymbol">£</span>85.00</span></ins>
                                        <del><span class="price-amount"><span class="currencySymbol">£</span>95.00</span></del>
                                    </div>
                                    <div class="slide-down-box">
                                        ...
                                        <div class="buttons">
                                            <NuxtLink to="/#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></NuxtLink>
                                            <NuxtLink to="/#" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>add to cart</NuxtLink>
                                            <NuxtLink to="/#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></NuxtLink>
                                        </div>
                                    </div>
                                </div>
                            </div>
