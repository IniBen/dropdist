                ...
                >
                  ...
                  <ul class="addr-info">
                    ...
                    <li>
                      <div class="if-item">
                        <b class="tie">Phone:</b>
                        <p class="dsc">0800 0NEW DEVZ</p>
                      </div>
                    </li>
                    <li>
                      <div class="if-item">
                        <b class="tie">Email:</b>
                        <p class="dsc">dropdevz@newdevz.com</p>
                      </div>
                    </li>
                    <li>
                      <div class="if-item">
                  ...
                  <div class="biolife-social inline">
                    <ul class="socials">
                      <li>
                        <NuxtLink to="/#" title="twitter" class="socail-btn"
                          ><i class="fa fa-twitter" aria-hidden="true"></i
                        ></NuxtLink>
                      </li>
                      <li>
                        <NuxtLink to="/#" title="facebook" class="socail-btn"
                          ><i class="fa fa-facebook" aria-hidden="true"></i
                        ></NuxtLink>
                      </li>
                      <li>
                        <NuxtLink to="/#" title="pinterest" class="socail-btn"
                          ><i class="fa fa-pinterest" aria-hidden="true"></i
                        ></NuxtLink>
                      </li>
                      <li>
                        <NuxtLink to="/#" title="youtube" class="socail-btn"
                          ><i class="fa fa-youtube" aria-hidden="true"></i
                        ></NuxtLink>
                      </li>
                      <li>
                        <NuxtLink to="/#" title="instagram" class="socail-btn"
